...
function App() {
  return (
    <div className="min-h-screen bg-[#121212] text-gray-300 p-8 md:p-16">
      <div className="max-w-5xl mx-auto">
        ...
        <header className="flex justify-between items-center mb-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="mailto:sarkar.ab07@gmail.com">
              <span className="text-gray-500 hover:text-gray-200 transition-transform ease-in-out duration-300">
        ...
        <div className="space-y-4 mb-12">
          ...
          <div className="flex justify-between items-center">
            <div>
              <div className="flex items-center gap-2">
                <a href="https://github.com/abhoy21/yaadho.git" target="_blank">
                ...
                <a href="https://yaadho.vercel.app/" target="_blank">
                  <h3 className="text-gray-200 hover:text-gray-500">Yaad-Ho</h3>
                </a>
              </div>
            ...
            <div className="flex items-center gap-2">
              <span className="text-gray-500">5 users</span>
          ...
          <div className="flex justify-between items-center">
            <div>
              <div className="flex items-center gap-2">
                <a href="https://github.com/abhoy21/writex.git" target="_blank">
                  <svg className="h-5 w-5" fill="white" viewBox="0 0 24 24">
                    <path
                      clipRule="evenodd"
                      d="M12 2C6.477 2 2 6.477 2 12c0 4.42 2.87 8.17 6.84 9.5.5.08.66-.23.66-.5v-1.69c-2.77.6-3.36-1.34-3.36-1.34-.46-1.16-1.11-1.47-1.11-1.47-.91-.62.07-.6.07-.6 1 .07 1.53 1.03 1.53 1.03.87 1.52 2.34 1.07 2.91.83.09-.65.35-1.09.63-1.34-2.22-.25-4.55-1.11-4.55-4.92 0-1.11.38-2 1.03-2.71-.1-.25-.45-1.29.1-2.64 0 0 .84-.27 2.75 1.02.79-.22 1.65-.33 2.5-.33.85 0 1.71.11 2.5.33 1.91-1.29 2.75-1.02 2.75-1.02.55 1.35.2 2.39.1 2.64.65.71 1.03 1.6 1.03 2.71 0 3.82-2.34 4.66-4.57 4.91.36.31.69.92.69 1.85V21c0 .27.16.59.67.5C19.14 20.16 22 16.42 22 12A10 10 0 0012 2z"
                ...
                <a
                  ...
                  target="_blank"
                >
                  <h3 className="text-gray-200 hover:text-gray-500">Writex</h3>
                </a>
              </div>
              <p className="text-gray-500">
                - Generate SEO optimized contents for your business needs with
                AI
              </p>
            </div>
            <div className="flex items-center gap-2">
          ...
          <div className="my-12">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                ...
                <span className="text-gray-500">Dec 31, 2024</span>
              </div>
              <div className="flex justify-between items-center">
                <a
                ...
                <span className="text-gray-500">Jan 02, 2025</span>
              </div>
            </div>
          </div>
          ...
          <div className="my-12">
            ...
            <GitHubCalendar username="abhoy21" />
          </div>
        </div>
      </div>
    </div>
